...
var max_speed = 20									# velocity multiplier applied to every movement
var mouse_sensitivity = 0.003						# translating the mouse XY coordinates into angular (radian) movement
